...
import com.sakayori.music.constants.AndroidAutoSearchLocalLimitKey
...
import com.sakayori.music.constants.AndroidAutoSectionsOrderKey
import com.sakayori.music.constants.AndroidAutoYouTubePlaylistsKey
...
import com.sakayori.music.ui.screens.settings.AndroidAutoSection
import com.sakayori.music.ui.screens.settings.deserializeSections
import com.sakayori.music.ui.screens.settings.serializeSections
                ...
                val children = when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.sakayori.innertube.pages.HomePage.Section>()
