...
object Updater {
    ...
    private const val GITHUB_API_BASE = "https://api.github.com/repos/Sakayorii/sakayori-music"
    private const val KMP_RELEASES_URL = "https://api.github.com/repos/Sakayorii/sakayori-music/releases?per_page=30"
    const val KMP_APK_NAME = "SakayoriMusic.apk"
    ...
    private fun parseAssets(assetsArray: JSONArray): List<ReleaseAsset> {
        ...
        for (i in 0 until assetsArray.length()) {
            ...
            val (arch, variant) = when {
                name == "SakayoriMusic.apk" -> "universal" to "foss"
                name == "SakayoriMusic-with-Google-Cast.apk" -> "universal" to "gms"
