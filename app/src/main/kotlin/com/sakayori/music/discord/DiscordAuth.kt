...
import com.sakayori.music.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.sakayori.music.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.sakayori.music.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    companion object {
        ...
        const val REDIRECT_URI = "sakayoridiscord://oauth2/callback"
