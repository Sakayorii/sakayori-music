...
# Since Sakayori Music is fully open-source, obfuscation provides no meaningful security benefit.
-dontobfuscate

# WebView JavaScript interfaces
-keepclassmembers class com.sakayori.music.utils.cipher.CipherWebView {
    @android.webkit.JavascriptInterface public *;
}
-keepclassmembers class com.sakayori.music.utils.potoken.PoTokenWebView {
    @android.webkit.JavascriptInterface public *;
}

# Keep streaming utility classes
-keep class com.sakayori.music.utils.cipher.** { *; }
-keep class com.sakayori.music.utils.potoken.** { *; }
...
-keep class com.sakayori.music.models.PersistQueue { *; }
-keep class com.sakayori.music.models.PersistPlayerState { *; }
-keep class com.sakayori.music.models.QueueData { *; }
-keep class com.sakayori.music.models.QueueType { *; }
-keep class com.sakayori.music.playback.queues.** { *; }
...
## Google Cast Rules
-keep class com.sakayori.music.cast.** { *; }
...
-keep class com.sakayori.music.recognition.VibraSignature { *; }
-keepclassmembers class com.sakayori.music.recognition.VibraSignature {
    native <methods>;
}
...
-keep class com.sakayori.music.listentogether.proto.** { *; }
-keepclassmembers class com.sakayori.music.listentogether.proto.** { *; }

## Shazam Models
-keep class com.sakayori.shazamkit.models.** { *; }
-keepclassmembers class com.sakayori.shazamkit.models.** {
    *;
}

## Discord RPC JNI
-keep class com.sakayori.music.discord.DiscordRpcManager { *; }
-keepclassmembers class com.sakayori.music.discord.DiscordRpcManager {
    native <methods>;
}
...
-keepclasseswithmembers class com.sakayori.shazamkit.models.** {
    kotlinx.serialization.KSerializer serializer(...);
}
