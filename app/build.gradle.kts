...
val baseApplicationId = "com.sakayori.music"
val applicationIdOverride = System.getenv("SAKAYORI_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("SAKAYORI_APP_NAME")?.takeIf { it.isNotBlank() }
val buildCommit =
    System.getenv("SAKAYORI_BUILD_COMMIT")
        ?.trim()
        ?.takeIf { it.matches(Regex("[0-9a-fA-F]{7,40}")) }
        ?.take(7)
        ?.lowercase()
val debugKeystorePathOverride = System.getenv("SAKAYORI_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("SAKAYORI_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("SAKAYORI_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("SAKAYORI_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        resValue("string", "app_name", appNameOverride ?: "Sakayori Music")
        ...
        buildConfigField("Long", "DISCORD_APP_ID", "1540430361555898419L")
    }
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "Sakayori Music Debug")
            }
            signingConfig =
...
val protoDir = rootProject.file("../sakayori-proto")
