...
* Kh?i ch?y d? án Sakayori Music (Rebranded t? Sakayori Music)
* Hoàn thi?n ki?n trúc thuong hi?u m?i
...
Sakayori Music KMP is almost ready. We are ironing out the remaining bugs and preparing for release, but it is still at least a couple of weeks away.
...
- Improved automatic player configuration updates for future YouTube changes (@Sakayorii @nyxiereal)
...
## New Contributors
* @SimoneFelici made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/4102
* @arpitagarwal1301 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/4178

**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.6.1...v13.6.2
...
- Fixed black screens, startup crashes, and playback freezes (@kairosci @Sakayorii @nyxiereal)
- Improved Listen Together synchronization (@nyxiereal)

## Notable new features
- Added refreshed branding and an optional dynamic app icon (@Sakayorii)
- Added predictive back support and improved landscape scaling (@HansHolz09 @kairosci)

## Other improvements
- Fixed login, logout, and backup restoration issues (@Sakayorii @kairosci @nyxiereal)
- Fixed incorrect artist names, song durations, podcast metadata, and missing artwork (@alltechdev @kairosci @Sakayorii @nyxiereal)
- Fixed Android Auto freezes and playback delays (@kairosci)
- Fixed foreground service ANRs and multiple other crashes (@kairosci @Sakayorii)
- Fixed sleep timer crashes and restored saved defaults (@johannesbrauer @Sakayorii)
- Improved library sync performance and YouTube player compatibility (@Sakayorii @nyxiereal)

## New Contributors
* @HansHolz09 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3837

**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.6.0...v13.6.1
...
## New Contributors
- @DanielSchmerber made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3777
- @Arjuanto made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3780
...
## New Contributors
- @Jeff0945 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3358
...
## New Contributors
- @ndellagrotte made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3487
- @cmeka made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3534
- @punkscience made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3517
...
- Fixed multiple playback issues and prepared for YouTube's player changes (@Sakayorii @nyxiereal)
...
## New Contributors
* @ibratabian17 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3474
* @sasha-melech made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3301
* @FireLion137 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3500
* @binimum made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3493
* @stopper2408 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3506
* @SunjeetKajla made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3505
...
We are working on something big for the future of Sakayori Music - this is not the end of the project.
...
- Prevented UI state reset when switching apps (@Sakayorii)
- Restored the Daily Discover title in the Home screen (@Sakayorii)
...
## New Contributors
* @AntonioDionisio05 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3255
* @David-2765 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3271
* @luigiwwmf made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3293
* @gergesh made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3300
* @Lolen10 made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3328

**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.3.0...v13.3.1
---v13.3.0
# Major changes
- Implemented song upload and delete functionality (@alltechdev)
- Multiple playback fixes and reliability improvements (@alltechdev, @Sakayorii)
- Fixed proguard rules causing issues with Reproducible Builds (@nyxiereal)
- Fixed proguard rules removing Listen Together protobuf classes (@Sakayorii)
...
## New Contributors
* @isotjs made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/3090

**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.2.1...v13.3.0
---v13.2.1
>[!WARNING]
...
**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.2.0...v13.2.1
---v13.2.0
# Major changes
- Fixed playback breaking due to YouTube's February 2026 n-transform changes (@alltechdev)
- Added full podcast library support (@Sakayorii & @alltechdev)
- Redesigned loading, Changelog, and About screens (@adrielGGmotion)
- Improved app startup time via parallelized home screen loading (@Sakayorii)

## Notable new features
- Added an option to cache songs only after playback has started (@kairosci)
- Added a music recognizer home screen widget (@Sakayorii)
- Rewrote music recognizer in pure Kotlin, removing NDK dependency and reducing APK size (@Sakayorii)
...
- Fixed a crash on the About screen on some devices (@Sakayorii)
- Fixed home screen playlist navigation routing to wrong screen (@Sakayorii)
- Fixed crash when creating local playlists (@Sakayorii)

## New Contributors
* @johannesbrauer made their first contribution in https://github.com/Sakayorii/sakayori-music/pull/2991

**Full Changelog**: https://github.com/Sakayorii/sakayori-music/compare/v13.1.1...v13.2.0
